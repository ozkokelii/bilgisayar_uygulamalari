...
import 'package:birim_don/backdrop.dart';
import 'package:birim_don/category_tile.dart';
import 'package:birim_don/unit_converter.dart';
...
class _CategoryRouteState extends State<CategoryRoute> {
  ...
  static const _icons = <String>[
    ...
    'assets/icons/surat.png',
    'assets/icons/mass.png',
    'assets/icons/time.png',
    'assets/icons/digital_storage.png',
    'assets/icons/power.png',
    'assets/icons/basinc.png',
  ...
  Widget build(BuildContext context) {
    ...
    return Backdrop(
      ...
      backPanel: listView,
      frontTitle: Text('Birim Dönüştürücü'),
      backTitle: Text('Kategori Seçiniz'),
    );
  }
}
